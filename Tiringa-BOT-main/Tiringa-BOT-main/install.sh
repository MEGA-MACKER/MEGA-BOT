...
echo -e " ${RED} MEGA-MACKER"
sleep 2

echo -e " ${YELLOW} fala cara o "
...
echo -e " ${YELLOW} Traduzido e modifcado por MEGA. Base original por MhankBarBar"
echo -e " ${YELLOW} Use o comando: ${GREEN}npm start ${YELLOW}para iniciar o bot."
echo -e " ${GREEN} Caso encontre ou ocorra algum erro na instalação, me chame no whats:${YELLOW}5571986203286."
